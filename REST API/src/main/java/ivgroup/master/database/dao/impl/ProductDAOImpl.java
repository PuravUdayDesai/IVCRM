...
public class ProductDAOImpl implements ProductDAO{
	...
	@Override
	public List<ProductSelect> selectProductsByOwnerId(Long ownerId) throws SQLException, ClassNotFoundException 
	{
		List<ProductSelect> lps=new ArrayList<ProductSelect>();
		Connection c=ConnectionProvider.getConnection();
		CallableStatement stmt=c.prepareCall("SELECT * FROM \"product\".\"fn_selectProductByOwnerId\"(?);");
