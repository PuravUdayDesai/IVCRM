...
public class CompanyDAOImpl implements CompanyDAO{
	...
	public HashMap<Long, Long> addCompanyWithCompanyBranchTypeAndPosition(CompanyInsetWithCompanyBranchTypeAndExecutivePosition ci) throws SQLException, ClassNotFoundException 
	{
		...
		stmt.setInt(30, ci.getCompanyGrant());
		stmt.setInt(31, ci.getCompanyBranchGrant());
		stmt.setInt(32, ci.getCompanyExecutiveGrant());
		stmt.setInt(33, ci.getClientGrant());
		stmt.setInt(34, ci.getProductGrant());
		stmt.setInt(35, ci.getLocationGrant());
		stmt.setInt(36, ci.getEnquiryGrant());
		stmt.setInt(37, ci.getTicketGrant());
		stmt.setInt(38, ci.getPositionGrant());
