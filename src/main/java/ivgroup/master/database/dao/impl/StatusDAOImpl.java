...
public class StatusDAOImpl implements StatusDAO
{
	...
	@Override
	public List<StatusSelect> selectStatusByOwnerId(Long ownerId) throws SQLException, ClassNotFoundException 
	{
		Connection c=ConnectionProvider.getConnection();
		CallableStatement stmt=c.prepareCall("SELECT * FROM \"status\".\"fn_selectStatusByOwnerId\"(?)");
