...
public class CompanyExecutiveGeoMapPlottingController 
{
	...
	public ResponseEntity<List<CompanyExecutiveGeoMapPlotting>> getCompanyExecutiveGeoMapByOwnerId(@RequestParam("ownerId") @NotNull Long ownerId)
	{
	...
	public ResponseEntity<List<CompanyExecutiveGeoMapPlotting>> getCompanyExecutiveGeoMapByCompanyId(@RequestParam("companyId") @NotNull Long companyId)
	{
	...
	public ResponseEntity<List<CompanyExecutiveGeoMapPlotting>> getCompanyExecutiveGeoMapByCountryId(@RequestParam("ownerId") @NotNull Long ownerId,@RequestParam("countryId") @NotNull  Long countryId)
	{
	...
	public ResponseEntity<List<CompanyExecutiveGeoMapPlotting>> getCompanyExecutiveGeoMapByStateId(@RequestParam("ownerId") @NotNull Long ownerId,@RequestParam("countryId") @NotNull  Long countryId,@RequestParam("stateId") @NotNull  Long stateId)
	{
	...
	public ResponseEntity<List<CompanyExecutiveGeoMapPlotting>> getCompanyExecutiveGeoMapByCityId(@RequestParam("ownerId") @NotNull Long ownerId,@RequestParam("countryId") @NotNull  Long countryId,@RequestParam("stateId") @NotNull  Long stateId,@RequestParam("cityId") @NotNull  Long cityId)
	{
