...
public class BusinessAreaForCompanyBusinessLogic {
	...
	private ResponseEntity<Void> updateAreaAreaName(Connection c, Long areaId, String areaName) {
		Boolean rs = false;
		try {
			rs = businessAreaForCompany_dao.updateAreaName(c, areaId, areaName);
	...
	private ResponseEntity<Void> updateAreaAreaCode(Connection c, Long areaId, String areaCode) {
		Boolean rs = false;
		try {
			rs = businessAreaForCompany_dao.updateAreaCode(c, areaId, areaCode);
		} catch (ClassNotFoundException e) {
			return new ResponseEntity<Void>(HttpStatus.NOT_FOUND);
		} catch (SQLException e) {
			return new ResponseEntity<Void>(HttpStatus.INTERNAL_SERVER_ERROR);
	...
	private ResponseEntity<Void> updateAreaAreaDescription(Connection c, Long areaId,
		...
		Boolean rs = false;
		try {
			rs = businessAreaForCompany_dao.updateAreaDescription(c, areaId, areaDescription);
		} catch (ClassNotFoundException e) {
			return new ResponseEntity<Void>(HttpStatus.NOT_FOUND);
		} catch (SQLException e) {
			return new ResponseEntity<Void>(HttpStatus.INTERNAL_SERVER_ERROR);
	...
	private ResponseEntity<Void> updateBusinessAreaForCompanyCityID(Connection c, Long businessAreaForCompanyId, Long cityId) {
		Boolean rs = false;
		try {
			rs = businessAreaForCompany_dao.updateBusinessAreaForCompanyCityID(c, businessAreaForCompanyId, cityId);
		} catch (ClassNotFoundException e) {
			return new ResponseEntity<Void>(HttpStatus.NOT_FOUND);
		} catch (SQLException e) {
			return new ResponseEntity<Void>(HttpStatus.INTERNAL_SERVER_ERROR);
	...
	public ResponseEntity<Void> updateBusinessAreaForCompany(Long businessAreaForCompanyId, BusinessAreaForCompanyUpdate businessAreaForCompany_info) {
		...
		if (businessAreaForCompany_info.getAreaName() != null && businessAreaForCompany_info.getAreaID() != null) {
			rs = updateAreaAreaName(c, businessAreaForCompany_info.getAreaID(), businessAreaForCompany_info.getAreaName());
			wentIn = true;
		}
		...
		if (businessAreaForCompany_info.getAreaCode() != null && businessAreaForCompany_info.getAreaID() != null) {
			rs = updateAreaAreaCode(c, businessAreaForCompany_info.getAreaID(), businessAreaForCompany_info.getAreaCode());
			wentIn = true;
		}
		if (rs != null && rs.getStatusCode() != HttpStatus.OK && wentIn) {
			wentIn = false;
		...
		if (businessAreaForCompany_info.getAreaDescription() != null && businessAreaForCompany_info.getAreaID() != null) {
			rs = updateAreaAreaDescription(c, businessAreaForCompany_info.getAreaID(), businessAreaForCompany_info.getAreaDescription());
			wentIn = true;
		}
		if (rs != null && rs.getStatusCode() != HttpStatus.OK && wentIn) {
			wentIn = false;
		...
		if (businessAreaForCompany_info.getCityID() != null) {
			rs = updateBusinessAreaForCompanyCityID(c, businessAreaForCompanyId, businessAreaForCompany_info.getCityID());
			wentIn = true;
		}
		if (rs != null && rs.getStatusCode() != HttpStatus.OK && wentIn) {
			wentIn = false;
