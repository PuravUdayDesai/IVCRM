...
public class TicketController 
{
	...
	public ResponseEntity<Void> deleteTicketAccessList(@PathVariable @NotNull Long ticketAccessListId,@RequestParam("companyExecutiveId") Long companyExecutiveId) 
	{
		return tbl.deleteTicketAccessList(ticketAccessListId,companyExecutiveId);
	}
	
	@DeleteMapping(path="/ticketFollowupDate/{ticketFollowupDateId}")
	public ResponseEntity<Void> deleteTicketFollowupDate(@PathVariable @NotNull Long ticketFollowupDateId,@RequestParam("companyExecutiveId") Long companyExecutiveId)
	{
		return tbl.deleteTicketFollowupDate(ticketFollowupDateId,companyExecutiveId);
	}
