...
class ClientState extends State<Client> with TickerProviderStateMixin{

  static var currentCompany;
  ...
  String filter="/company/${CurrentUser.companyId}";
        ...
        Card(
            ...
            child: ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder : (context) => UpdateClient(obj))
                  ).then((value){
                    if(value!=null){
  ...
  Widget build(BuildContext context) {
                              ...
                              onPressed : (){
                                ...
                                setState((){
                                  if(filterChipCountry == 'Country'){
                                    getNewData = true;
                                    filter = '/company/${CurrentUser.companyId}';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          //addStatus();
          Navigator.pushNamed(context,'/add_client').then((value){
            if(value!=null){
      ...
      // floatingActionButton : FloatingActionButton.extended(
      //   onPressed : (){
      //     showMessage('Deleted Successfully.!!',Colors.grey[800]);
      //   },
      //   icon : Icon(Icons.add),
      //   label : Text('Add'),
      // ),
            ...
            child: ListTile(
                ...
                onTap: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder : (context) => UpdateClient(suggestionList[index]))
                  );
                  //updateCity(obj);
                })),
        Divider(),
