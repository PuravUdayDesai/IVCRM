...
class AddEnquiryAdmin extends StatefulWidget{
	
	@override
	_AddEnquiryAdmin createState() => _AddEnquiryAdmin();
}

class _AddEnquiryAdmin extends State<AddEnquiryAdmin> with SingleTickerProviderStateMixin{
