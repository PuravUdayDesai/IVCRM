...
import 'update_ticket_admin.dart';





class TicketAdmin extends StatefulWidget{

  String ticketName;
  TicketAdmin({this.ticketName});

  @override
  TicketAdminState createState () => TicketAdminState();
}

List<TicketClass> tickets = [];

class TicketAdminState extends State<TicketAdmin> with SingleTickerProviderStateMixin{
    ...
    if(isFilterApply){
      ...
      if(getNewData){
        ...
        if(getNewFilterData){
          ...
          var allstatuses = await ApiCall.getDataFromApi(Uri.GET_STATUS+'/owner/${CurrentUser.id}');
        ...
        Card(
            ...
            child: ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder : (context) => UpdateTicketAdmin(obj))
                  ).then((value){
                    if(value!=null){
                      if(value){
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      key : _scaffoldKey,
      drawer: CustomDrawer(ticketSelected : true),
      appBar : AppBar(
            ...
            child: ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder : (context) => UpdateTicketAdmin(suggestionList[index])
                    )
                  );
                })),
        Divider(),
